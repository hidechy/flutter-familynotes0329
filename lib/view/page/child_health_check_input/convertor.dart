...
class ChildCheckUpRequestConverter {
  ...
  static ChildCheckupRecordSaveRequest convertFrom({
    ...
    return ChildCheckupRecordSaveRequest(
      ...
      weight: isUnitGram ? int.tryParse(inputData.weight) : int.tryParse(inputData.weight.toGram()),
      head: double.tryParse(inputData.head),
      chest: double.tryParse(inputData.chest),
      isNormal: inputData.result == ChildCheckUpResultType.noProblem ? '1' : '0',
      isObservation: inputData.result == ChildCheckUpResultType.followUp ? '1' : '0',
      isDetailedExamination: inputData.result == ChildCheckUpResultType.detailedExamination ? '1' : '0',
      isTreatment: inputData.result == ChildCheckUpResultType.needTreatment ? '1' : '0',
